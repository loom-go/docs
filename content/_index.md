...
[*] **Multi-plateform** | The only thing loom needs is a [renderer](/docs/renderers). Build a UI for your calculator if you want.

[*] **Signal-based** | Performant fine-grained reactive updates. You [decide](/docs/bind) what part of the tree gets to update.
